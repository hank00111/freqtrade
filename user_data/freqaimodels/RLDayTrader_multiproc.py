...
class RLDayTrader_multiproc(ReinforcementLearner_multiproc):
    ...
    class MyRLEnv(Base4ActionRLEnv):
        ...
        Forced close at max_trade_duration_candles (prop firm rule).
        """
        ...
        def step(self, action):
            """Override step to force close at max_trade_duration_candles (prop firm rule)."""
        ...
        def calculate_reward(self, action: int) -> float:
            ...
            Forced close at max_trade_duration_candles via step() override.
            """
