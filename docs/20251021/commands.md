.\.venv\Scripts\Activate.ps1; freqtrade backtesting --strategy RLStrategy4Action --config user_data/config_dqn_gpu.json --freqaimodel ReinforcementLearner4Action --timerange 20230101-20251019
